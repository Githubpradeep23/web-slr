      ...
      <div className="mx-auto px-[8px] md:px-[36px] mt-[50px] xl:px-4 lg:mt-[20px] py-5">
        ...
        <div className="lg:grid lg:grid-cols-2 md:gap-y-[34px] lg:gap-x-[70px] gap-[100px] px-8">
          ...
          <div className="relative mr-16">
            ...
            <Image width={"0"} height={"0"} src={"../assets/images/Asset-2.png"} className='object-cover mx-auto mb-[30px] lg:mb-0 lg:flex-1 w-[25%] fade opacity-50' width={"145"} height
              ={"127"} alt='/' />
            <Image width={"0"} height={"0"} src={"../assets/images/Asset-1.png"} className='absolute shadow-3 rounded-2xl top-1 right-[85px] animate-float w-[40%] opacity-50' width={"145"} height
              ={"127"} alt='/' />
            <Image width={"0"} height={"0"} src={"../assets/images/Asset-3.png"} className='absolute shadow-3 rounded-2xl right-[85px] animate-float -bottom-5 w-[30%] opacity-50' width={"145"} height
              ={"127"} alt='/' />
