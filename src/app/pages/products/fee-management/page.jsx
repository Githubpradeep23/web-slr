...
const page = () => {
  ...
  return (
    ...
    <>
      ...
      <div id='home' className={`md:h-screen md:bg-fee_management md:w-full h-[250px] bg-cover bg-center bg-no-repeat`} >
      ...
      <div id='about' className='md:p-4 w-full bg-gradient-to-r from-[#FFFFFF] from-15% via-[#FCFFFE80] via-20% to-[#75EAE440] to-100% text-center py-2' >
