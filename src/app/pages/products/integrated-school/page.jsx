      ...
      <div className='container md:w-full mx-auto ' >
        ...
        <div className='m-auto md:max-w-6xl md:grid grid-cols-2 md:mt-10'>
          ...
          <div className="rounded-lg flex justify-center items-center">
            <Image width={300} height={"0"} src={"../../public/assets/images/home-banner/streamline-school.png"} className='' alt='/' />
          </div>
        ...
        <div className='m-auto md:max-w-6xl md:grid grid-cols-2 md:mt-10'>
          ...
          <div className="rounded-lg flex justify-center items-center">
            <Image width={300} height={"0"} src={"../../assets/images/home-banner/efficiency.png"} className='' alt='/' />
          </div>
        ...
        <div className='m-auto md:max-w-6xl md:grid grid-cols-2 md:mt-10'>
          ...
          <div className="rounded-lg flex justify-center items-center">
            <Image width={300} height={"0"} src={"../../assets/images/home-banner/innovative.png"} className='' alt='/' />
          </div>
