...
const page = () => {
    ...
    const cuttingAdege = [
        { name: "Programming Languages", content: "Our expert developers are fluent in a multitude of programming languages Python, JavaScript, Java, C, C# and PHP, tailoring each project to the language best suited for optimal performance and functionality.", imageUrl: "/assets/images/home-banner/services-2.png" },
        { name: "Mobile App Development Frameworks", content: "With cutting-edge frameworks like React Native and Flutter, we create cross-platform apps that seamlessly operate on various devices, reducing development time and costs.", imageUrl: "/assets/images/home-banner/services-2.png" },
        { name: "Web Development Technologies", content: "Utilizing HTML5, CSS3, and dynamic JavaScript libraries, we design interactive and visually stunning web applications that captivate users and drive engagement.", imageUrl: "/assets/images/home-banner/services-2.png" },
        { name: "Database Management Systems", content: "From traditional databases like MySQL to NoSQL solutions like MongoDB, we employ a wide spectrum of database systems, ensuring data is efficiently stored and retrieved per project requirements.", imageUrl: "/assets/images/home-banner/services-2.png" },
    ];
                            ...
                            {services && services.map((list, index) => (
                                <div key={list.name} className='grid grid-cols-2'>
                                    <div className='m-auto text-left'>
                                        <Image src={list.imageUrl} width='75' height='75' layout="fixed" alt='/' />
                                    </div>
                            ...
                            {cuttingAdege && cuttingAdege.map((listFour, index) => (
                                ...
                                <div className="mb-8 rounded-[20px] bg-white">
                                    <div className="bg-primary flex h-[60px] w-[70px] items-center justify-start rounded-2xl">
                                            {listFour.imageUrl &&
                                                <Image width={"0"} height={"0"} src={listFour.imageUrl} className='object-cover w-8' alt='/' />
                                            }
                                    </div>
