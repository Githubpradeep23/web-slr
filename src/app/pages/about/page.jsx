...
export default function about() {
   ...
   const portfolioSpectrum = [
      {
         title: "Custom Software", slug: "", description: "Developing tailored software products to address unique business challenges and enhance efficiency."
      },
      {
         title: "Expert Staffing", slug: "", description: `Providing skilled staffing solutions to support project needs and drive organizational success.`
      },
      {
         title: "SAP Solutions", slug: "", description: `Leveraging advanced SAP tools for efficient business process management and analytics.`
      },
      {
         title: "Web Development", slug: "", description: "Crafting innovative web applications for improved user experience and digital interaction."
      },
      {
         title: "Digital Marketing", slug: "", description: `Implementing strategic digital marketing campaigns for impactful brand presence and customer engagement`
      },
      {
         title: "EdTech Solutions", slug: "", description: ` Offering cutting-edge educational technology solutions to transform learning experiences and educational outcomes.`
      },
   ];
   ...
   return (
      ...
      <>
         ...
         <div className=''>
            ...
            <div id='about' className={`h-auto bg-gradient-to-r from-[#dcfffd] from-15% via-[#cafffc] via-20% to-[#bafffc] to-100% md:w-full`} >
